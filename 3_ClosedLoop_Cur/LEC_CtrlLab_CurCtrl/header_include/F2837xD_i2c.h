...
//======================================================================
//		Define and structure Variable
//======================================================================

#define	nWP_ENABLE			(GpioDataRegs.GPBSET.bit.GPIO34 = 1)		// WP = 1, Write protected
#define nWP_DISABLE         (GpioDataRegs.GPBCLEAR.bit.GPIO34 = 1)  // WP = 0, Write unprotected
