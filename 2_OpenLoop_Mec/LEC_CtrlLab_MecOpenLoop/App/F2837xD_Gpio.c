...
{
    EALLOW;
    //=== GPIO Initialization for LED_RED
    GpioCtrlRegs.GPBDIR.bit.GPIO34 = 1;
    GPIO_SetupPinOptions(34, GPIO_OUTPUT, GPIO_PUSHPULL);
    GPIO_SetupPinMux(34, GPIO_MUX_CPU1, 0);

    //=== GPIO Initialization for  LED_Blue
    GpioCtrlRegs.GPADIR.bit.GPIO31 = 1;
    GPIO_SetupPinMux(31, GPIO_MUX_CPU1, 0);
    GPIO_SetupPinOptions(31, GPIO_OUTPUT, GPIO_PULLUP);
    GpioDataRegs.GPADAT.bit.GPIO31 = 1;

    //=== GPIO Initialization for  Gate En able
    GpioCtrlRegs.GPDDIR.bit.GPIO124 = 1;
    GPIO_SetupPinMux(124, GPIO_MUX_CPU1, 0);
    GPIO_SetupPinOptions(124, GPIO_OUTPUT, GPIO_PULLUP);
    GpioDataRegs.GPDDAT.bit.GPIO124 = 1; //Initial

    //=== GPIO Initialization for  OT(Temperature)
    GpioCtrlRegs.GPDDIR.bit.GPIO111 = 0;
    GPIO_SetupPinMux(111, GPIO_MUX_CPU1, 0);
    GPIO_SetupPinOptions(111, GPIO_INPUT, GPIO_PULLUP|GPIO_INVERT);
   // GpioDataRegs.GPDDAT.bit.GPIO111 = 1; //Initial
    EDIS;
